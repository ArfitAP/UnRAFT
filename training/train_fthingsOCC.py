...
def fetch_dataloader(args, TRAIN_DS='C+T+K+S+H'):
    ...
    aug_params = {'crop_size': [312, 624], 'min_scale': -0.1, 'max_scale': 1.0, 'do_flip': True}
    
    
    #train_dataset = FlyingChairs(aug_params, split='training', root='E:\RAFT datasets\FlyingChairs\data')
    
    # Colab:
    train_dataset = FlyingThings3D(aug_params, dstype='frames_cleanpass', root='/content/FlyingThings')
